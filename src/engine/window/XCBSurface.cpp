...
void vkn::XCBSurface::initWindow()
{
...
/* Magic code that will send notification when window is destroyed */
    ...
    xcb_change_property(connection, XCB_PROP_MODE_REPLACE, window, XCB_ATOM_WM_NAME, XCB_ATOM_STRING, 8, strlen(APP_NAME), APP_NAME);
...
void vkn::XCBSurface::initSurface()
{
...
void vkn::XCBSurface::destroySurface()
{
    vkDestroySurfaceKHR(Instance::instance, surface, nullptr);
}

void vkn::XCBSurface::destroyWindow()
{
